...
<div class="social-share-buttons flex flex-wrap items-center gap-3 {{ $attributes->get('class') }}">
    <span class="text-sm font-semibold text-base-content/70 mr-2">Share:</span>
    
    <!-- Facebook -->
    <a href="#" 
       class="social-share-btn flex items-center justify-center w-10 h-10 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors duration-200 shadow-md hover:shadow-lg"
    ...
    <!-- X (Twitter) -->
    <a href="#" 
       class="social-share-btn flex items-center justify-center w-10 h-10 rounded-lg bg-black hover:bg-gray-800 text-white transition-colors duration-200 shadow-md hover:shadow-lg"
    ...
    <!-- WhatsApp -->
    <a href="#" 
       class="social-share-btn flex items-center justify-center w-10 h-10 rounded-lg bg-green-600 hover:bg-green-700 text-white transition-colors duration-200 shadow-md hover:shadow-lg"
    ...
    <!-- Telegram -->
    <a href="#" 
       class="social-share-btn flex items-center justify-center w-10 h-10 rounded-lg bg-blue-500 hover:bg-blue-600 text-white transition-colors duration-200 shadow-md hover:shadow-lg"
    ...
    <!-- Email -->
    <a href="#" 
       class="social-share-btn flex items-center justify-center w-10 h-10 rounded-lg bg-gray-700 hover:bg-gray-800 text-white transition-colors duration-200 shadow-md hover:shadow-lg"
       data-platform="email"
       data-article-id="{{ $articleId }}"
       data-page-url="{{ $pageUrl }}"
